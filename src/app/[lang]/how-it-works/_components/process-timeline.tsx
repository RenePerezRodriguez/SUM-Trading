            ...
            >
                <div className="flex gap-6 md:gap-8">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <motion.div 
                            className={cn(
                                "relative z-10 flex h-16 w-16 md:h-20 md:w-20 items-center justify-center rounded-2xl transition-all duration-300",
                                "bg-gradient-to-br from-primary/10 to-primary/5 border-2 border-primary/30",
                                "group-hover:border-primary group-hover:shadow-xl group-hover:shadow-primary/20 group-hover:scale-110"
                            )}
                        ...
                        >
                            ...
                            >
                                <Icon className="h-8 w-8 md:h-10 md:w-10 text-primary transition-all duration-300 group-hover:text-primary" />
                            </motion.div>
                    ...
                    <div className="flex-1 pb-12">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                whileHover={{ y: -4 }}
                            >
                                <h3 className="text-2xl md:text-3xl font-bold font-headline mb-3 transition-colors duration-300 group-hover:text-primary flex items-center gap-2">
                                    {step.title}
