...
export async function updateExistingPurchaseRecordAction(data: UpdatePurchaseData): Promise<{ success: boolean; error?: string; }> {
    ...
    try {
        ...
        if (purchaseSnapshot.empty) {
            ...
            // revalidateTag('profile-layout'); // TODO: Fix revalidateTag for Next.js 16
        ...
        // revalidateTag('purchases-page'); // TODO: Fix revalidateTag for Next.js 16
        // revalidateTag('copart-checkout-page');
        // revalidateTag('update-success-page');
