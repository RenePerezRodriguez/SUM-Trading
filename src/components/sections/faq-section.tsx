...
export default function FaqSection({ dict, lang }: { dict: any, lang: string }) {
  ...
  return (
    <section className="relative overflow-hidden bg-secondary/20">
      ...
      <div className="container relative z-10 pt-24 sm:pt-28 md:pt-32 pb-12 sm:pb-16 md:pb-24">
        <div className="max-w-4xl mx-auto">
          <FadeIn>
            ...
            <div className="mb-8 -mx-4 sm:mx-0">
              <div className="w-full flex overflow-x-auto sm:flex-wrap gap-2 bg-background p-2 sm:p-3 border shadow-sm sm:rounded-lg scrollbar-hide">
                <button
                  onClick={() => setActiveCategory('all')}
                  className={`px-3 sm:px-4 py-2 rounded-md font-semibold transition-all whitespace-nowrap text-sm sm:text-base shrink-0 ${activeCategory === 'all'
                ...
                {faqContent.categories.map((category: any) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 sm:px-4 py-2 rounded-md font-medium transition-all flex items-center gap-1.5 sm:gap-2 whitespace-nowrap text-sm sm:text-base shrink-0 ${activeCategory === category.id
                        ? 'bg-primary text-primary-foreground'
                        : 'hover:bg-secondary'
                        }`}
                    >
