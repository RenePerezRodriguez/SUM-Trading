...
export default function Footer({ lang, dict }: { lang: Locale, dict: any }) {
  ...
  const navLinks = [
    ...
    { href: `/${lang}/cars`, label: navigation.catalog },
    { href: `/${lang}/about`, label: navigation.about },
    { href: `/${lang}/how-it-works`, label: navigation.how_it_works },
  ...
  const legalLinks = [
    ...
    { href: `/${lang}/coordinacion-arrastres`, label: footer.coordinacion_arrastres || 'Coordinación de Arrastres' },
    ...
    <footer className="bg-muted border-t border-border">
      <div className="container py-12 md:py-16 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <FooterLinkColumn title={footer.contact || 'Contacto'} links={contactLinks} showSocial />
        </div>
        <FooterCopyright
