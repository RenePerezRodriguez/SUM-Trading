...
export const createVehicleSchema = (dict: any, isEditMode: boolean) => z.object({
  ...
  transmission: z.enum(transmissionTypes, { message: dict.validation.transmission_required }),
  ...
  titleType: z.enum(titleTypes, { message: dict.validation.titleType_required }),
