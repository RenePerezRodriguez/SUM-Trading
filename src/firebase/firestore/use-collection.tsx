...
export interface UseCollectionResult<T> {
  ...
  setData: React.Dispatch<React.SetStateAction<WithId<T>[] | null>>; // Allow manual update of data
}
        ...
        try {
            ...
            if ('path' in memoizedTargetRefOrQuery) {
                path = (memoizedTargetRefOrQuery as CollectionReference).path;
                 ...
                 // Fallback for complex queries, less reliable but better than crashing
                 path = (memoizedTargetRefOrQuery as any)._query.path.pieces.join('/');
            }
        } catch (e) {
